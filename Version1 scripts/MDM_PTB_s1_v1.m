function MDM_PTB_s1_v1(observer);
...
% "First two block finished"
    ...
    if randblock(1)==1 %monetay block first
        ...
        Screen(Win.win, 'FillRect',1);
        Screen('TextSize', Win.win, Datamed.stimulus.fontSize.pause);
        DrawFormattedText(Win.win,'Finished Two Blocks','center','center',Datamed.stimulus.fontColor);
        Screen('flip',Win.win);
        waitForBackTick;
    ...
    elseif randblock(1)==2 %medical block first
        ...
        Screen(Win.win, 'FillRect',1);
        Screen('TextSize', Win.win, Datamon.stimulus.fontSize.pause);
        DrawFormattedText(Win.win,'Finished Two Blocks','center','center',Datamon.stimulus.fontColor);
        Screen('flip',Win.win);
        waitForBackTick;
