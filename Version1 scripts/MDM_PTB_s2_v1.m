function MDM_PTB_s2_v1(observer);
% This function runs the second two sessions of the task, one Monetary and
% one Medical Block
...
blockNum=2; % second block of both monetary and medical
...
% "First two block finished"
    ...
    if randblock(1)==1 %monetay block first
        ...
        Screen(Win.win, 'FillRect',1);
        Screen('TextSize', Win.win, Datamed.stimulus.fontSize.pause);
        DrawFormattedText(Win.win,'Finished Four Blocks','center','center',Datamed.stimulus.fontColor);
        Screen('flip',Win.win);
        waitForBackTick;
    ...
    elseif randblock(1)==2 %medical block first
        ...
        Screen(Win.win, 'FillRect',1);
        Screen('TextSize', Win.win, Datamon.stimulus.fontSize.pause);
        DrawFormattedText(Win.win,'Finished four blocks','center','center',Datamon.stimulus.fontColor);
        Screen('flip',Win.win);
        waitForBackTick;
