function MDM_PTB_s3_v1(observer);
% This function runs the third two sessions of the task, one Monetary and
% one medical.
...
blockNum=3; % second block of both monetary and medical
...
% "First two block finished"
    ...
    if randblock(1)==1 %monetay block first
        ...
        Screen(Win.win, 'FillRect',1);
        Screen('TextSize', Win.win, Datamed.stimulus.fontSize.pause);
        DrawFormattedText(Win.win,'Finished Six Blocks','center','center',Datamed.stimulus.fontColor);
        Screen('flip',Win.win);
        waitForBackTick;
    ...
    elseif randblock(1)==2 %medical block first
        ...
        Screen(Win.win, 'FillRect',1);
        Screen('TextSize', Win.win, Datamon.stimulus.fontSize.pause);
        DrawFormattedText(Win.win,'Finished six blocks','center','center',Datamon.stimulus.fontColor);
        Screen('flip',Win.win);
        waitForBackTick;
