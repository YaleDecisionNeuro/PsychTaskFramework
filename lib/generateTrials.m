...
% the struct will contain (`stakes`, `probs`, `ambigs`) fields, and will
% combine them in a particular way (specifically, assuming that all ambiguous
% trials are coupled with .5 probability, and all probability trials have at
% least one appearance with zero ambiguity). It distributes all other subfields
% it finds randomly across thus generated trials.
%
