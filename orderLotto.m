...
% ORDERLOTTO Given the win color set for the trial, it returns two sorted
%   matrices with the probability (and, respectively, payoff) values sorted
%   such that the first will appear on top and the second on the bottom.
